...
(determinant_A = det(A))
```
*This area is the same as the area of the original transformation of $A$ without using the $k$ in matrix $M$. This is correct since transformations do not effect area.*
